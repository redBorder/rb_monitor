...
#define TEST1_CHECKS(mmonitor,mvalue) (struct json_key_test[]) {               \
	CHILD_I("sensor_id",1),                                                \
...
#define TEST1_LOAD_1_CHECKS \
	TEST1_CHECKS("load_1_per_instance","3.000000"), \
	TEST1_CHECKS("load_1_per_instance","2.000000"), \
	TEST1_CHECKS("load_1_per_instance","1.000000"), \
	TEST1_CHECKS("load_1_per_instance","0.000000")

#define TEST_LOAD_5(name) \
	TEST1_CHECKS(name,"4.000000"), \
	TEST1_CHECKS(name,"5.000000"), \
	TEST1_CHECKS(name,"6.000000"), \
	TEST1_CHECKS(name,"7.000000")
